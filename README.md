...
```
cd existing_repo
git remote add origin https://gitlab.com/developer12341/Todo.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/developer12341/Todo/-/settings/integrations)
